...
xLib is a Win32 API C++ OOP wrapper library/framework & `makefile` automation tool
...
- Automates project setup, documentation, windres resource compilation & simplifies the overall Win32 build processes.
...
```bash
> curl https://raw.githubusercontent.com/lambdadotjoburg/Win32xLib/main/Project/makefile >> makefile
```

or

```bash
> wget https://raw.githubusercontent.com/lambdadotjoburg/Win32xLib/main/Project/makefile >> makefile
```
...
> cd ./dependencies;\
> git init;\
> git remote add origin https://github.com/lambdadotjoburg/Win32xLib;\
> git config core.sparsecheckout true;\
> echo "/xLib/" >> .git/info/sparse-checkout;\
...
To explicityl generate a Win32 application program entry-point, run:
```bash
> make Win32
```
